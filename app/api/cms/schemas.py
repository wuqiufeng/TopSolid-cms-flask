...
definitions = {'definitions': {'ApiResponse': {'type': 'object', 'properties': {'status': {'type': 'integer'}, 'data': {'type': 'string'}, 'message': {'type': 'string'}}}, 'ErrorResponse': {'type': 'object', 'properties': {'status': {'type': 'integer'}, 'message': {'type': 'string'}, 'data': {'type': 'string'}}}, 'CustomUser': {'properties': {'user_login': {'type': 'string', 'description': '用户帐号'}, 'user_pass': {'type': 'string', 'description': '密码'}, 'new_pass': {'type': 'string', 'description': '新密码'}, 'captcha': {'type': 'string', 'description': '验证码'}, 'level': {'type': 'integer', 'description': '客服级别'}, 'real_name': {'type': 'string', 'description': '真实姓名'}, 'sex': {'type': 'integer', 'description': '性别'}, 'mobile': {'type': 'string', 'description': '手机号'}, 'card': {'type': 'string', 'description': '身份证号'}, 'company': {'type': 'string', 'description': '公司'}, 'area': {'type': 'array', 'items': {'properties': {'area_province': {'type': 'string'}, 'area_city': {'type': 'string'}, 'area_country': {'type': 'string'}, 'places': {'type': 'string'}}}}}}}, 'parameters': {}}

validators = {
    ('custom_user', 'POST'): {'json': {'$ref': '#/definitions/CustomUser'}},
}

filters = {
    ('custom_user', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/ApiResponse'}}},
}
